...
def hijack_prompt(original_prompt: T.Callable | None) -> None:
    ...
    def hijacked_prompt(current_prompt: str) -> None:
        ...
        global gdb
        # we don't need to re-hijack the prompt anymore
        REAL_GDB_MODULE.prompt_hook = original_prompt  # ty: ignore[invalid-assignment]
        sys.modules["gdb"] = gdb = REAL_GDB_MODULE
